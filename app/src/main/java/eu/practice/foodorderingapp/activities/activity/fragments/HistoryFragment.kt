...
class HistoryFragment : Fragment() {
    ...
    private fun setupRecycleView(){
        val buyAgainFoodName =  arrayListOf("Food 1","Food 2","Food 3","Food 4","Food 5","Food 6","Food 7")
        val buyAgainFoodPrice = arrayListOf("$45","$25","$35","$54","$25","$35","$54")
        val buyAgainFoodImage = arrayListOf(R.drawable.menu1,R.drawable.menu2,R.drawable.menu3,R.drawable.menu4,R.drawable.menu2,R.drawable.menu3,R.drawable.menu4)
